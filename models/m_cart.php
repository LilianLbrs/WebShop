...
$requete = "SELECT P.name, P.price, P.image, O.quantity FROM products P JOIN orderitems O ON (P.id = O.product_id) WHERE O.order_id = (SELECT id FROM orders WHERE customer_id = ? AND status = 10);";
$donnees = array(
	$_SESSION['id'],
);
