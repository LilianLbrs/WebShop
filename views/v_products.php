    ...
    ?>
        ...
        <div class="product ms-2 me-2 mb-4 mt-4">
            ...
            <div class="position-relative">
                ...
                <a type="button" href="index.php?page=product&product=<?= $product['id'] ?>" class="btn btn-dark bottom-0 end-0 position-absolute m-1">Acheter</a>
            </div>

            <div class="d-flex justify-content-between mt-2 description">
